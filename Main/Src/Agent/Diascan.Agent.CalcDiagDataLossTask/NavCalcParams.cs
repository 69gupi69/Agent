    ...
    public static class ConstNavCalcParams
    {
        private static readonly NavCalcParams binsParams = 
            new NavCalcParams()
            {
                ...
                ScanTimeLengt = 0.005,
                GravAccel = new NavCalcParamItem(9.8f, 0.1f),
                ...
                EarthAngularSpeedRotation = new NavCalcParamItem(0.0042f, 0.0005f),
                DifferenceLatitudes = new NavCalcParamItem(5f),
                AccelSum = new NavCalcParamItem(9.8f, 0.15f),
                AccelMax = new NavCalcParamItem(250f),
                AngularSpeedSum = new NavCalcParamItem(4f),
                AngularSpeedMax = new NavCalcParamItem(400f),
                AverageRollAngle = new NavCalcParamItem(2f),
                AveragePitchAngle = new NavCalcParamItem(2f),
                MaxRollAngle = new NavCalcParamItem(80f),
                MaxPitchAngle = new NavCalcParamItem(80f),
        ...
        private static readonly NavCalcParams adisParams =
            new NavCalcParams()
            {
                ...
                AccelSum = new NavCalcParamItem(9.8f, 0.5f),
                AccelMax = new NavCalcParamItem(300f),
                AngularSpeedSum = new NavCalcParamItem(6f),
