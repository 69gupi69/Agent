...
namespace Diascan.Agent.CalcDiagDataLossTask
{
    ...
    public static class ConstDiagDataParams
    {
        ...
        private static readonly DiagDataParams mflT32Params = new DiagDataParams(DataType.MflT32, 20d, 8.90f, 0.01f, 0.8f, 1);
        private static readonly DiagDataParams mflT33Params = new DiagDataParams(DataType.MflT33, 20d, 1.60f, 0.2f, 0.7f, 1);
        private static readonly DiagDataParams mflT34Params = new DiagDataParams(DataType.MflT34, 20d, 8.90f, 0.01f, 0.8f, 1);
        ...
        private static readonly DiagDataParams mpmParams = new DiagDataParams(DataType.Mpm, 36d, -2f, 3.18f, 0.3f, 1);
        ...
        private static readonly DiagDataParams emaParams = new DiagDataParams(DataType.Ema, 30d, 0.30f, 0f, 0.7f, 1);
