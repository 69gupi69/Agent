...
{
    public class CDpaDiagData : IDiagData
    {
        ...
        public CDpaDiagData(DataType dataType, FileHashed[] files, int id, float angle, float entryAngle, enCdmDirectionName dirName)
        {
            DataType = dataType;
            State = false;
