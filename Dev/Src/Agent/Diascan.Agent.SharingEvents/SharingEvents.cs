...
namespace Diascan.Agent.SharingEvents
{
    public static class SharingEvents
    {
        ...
        public delegate void SentPdiHandler(string omniFileName, ReferenceInputData referenceInputData, List<DataLocation> datasetLocation);
        public static event SentPdiHandler SentPdi;

        //  Получить данные для формы
        public delegate HeaderSession[] GetCalculationsHandler();
        ...
        //  обновить справочник CarrierData
        public delegate void DirectoryCarriersUpdateHandler();
        public static event DirectoryCarriersUpdateHandler DirectoryCarriersUpdate;
        ...
        //  загрузка формы
        public delegate Task<BindingList<HeaderSession>> FormLoadHandler();
        public static event FormLoadHandler FormLoad;

        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public static void OnSentPdi(string omnifilename, ReferenceInputData referenceInputData, List<DataLocation> datasetLocation)
        {
            SentPdi?.Invoke(omnifilename, referenceInputData,  datasetLocation);
        }

        public static HeaderSession[] OnGetCalculation()
        {
        ...
        public static void OnDirectoryCarriersUpdate()
        {
            DirectoryCarriersUpdate?.Invoke();
        }
        ...
        public static Task<BindingList<HeaderSession>> OnFormLoad()
        {
